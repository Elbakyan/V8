                                            ...
                                            <Route key={i} path={this.props.score.score.status? '/score/account/request/'+el.message[0].dialog + '/' + el.user.id
                                                ...
                                                <div className="message" >
                                                    ...
                                                    <div className='send_message'>
                                                        ...
                                                        {
                                                            this.state.reloadPos?<div className={!this.state.usersShow?'message_reload message_reload__bottom message_reload__none':'message_reload message_reload__bottom'}>
                                                                <span onClick={(e)=>{
                                                                    let aa = e.target
                                                                    e.target.classList.toggle('message_reload_button')
                                                                    this.props.dispatch(GetRequst())
